...
foreign lib {
	...
	*/
	generateVertexRemap :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertices: rawptr, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t) -> c.size_t ---
	...
	*/
	generateVertexRemapMulti :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t, streams: ^Stream, #any_int stream_count: c.size_t) -> c.size_t ---
	...
	*/
	generateVertexRemapCustom :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, callback: proc "c" (rawptr, u32, u32) -> i32, _context: rawptr) -> c.size_t ---
	...
	*/
	remapVertexBuffer :: proc(destination: rawptr, vertices: rawptr, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t, remap: ^u32) ---
	...
	* indices can be NULL if the input is unindexed
	*/
	remapIndexBuffer :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, remap: ^u32) ---
	...
	* destination must contain enough space for the resulting index buffer (index_count elements)
	*/
	filterIndexBuffer :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertices: rawptr, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t, #any_int vertex_stride: c.size_t) -> c.size_t ---
	...
	* stream_count must be <= 16
	*/
	filterIndexBufferMulti :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t, streams: ^Stream, #any_int stream_count: c.size_t) -> c.size_t ---
	...
	* destination must contain enough space for the resulting index buffer (index_count elements)
	*/
	generateShadowIndexBuffer :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertices: rawptr, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t, #any_int vertex_stride: c.size_t) ---
	...
	* stream_count must be <= 16
	*/
	generateShadowIndexBufferMulti :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t, streams: ^Stream, #any_int stream_count: c.size_t) ---
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	generatePositionRemap :: proc(destination: ^u32, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) ---
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	generateAdjacencyIndexBuffer :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) ---
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	generateTessellationIndexBuffer :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) ---
	...
	*/
	generateProvokingIndexBuffer :: proc(destination: ^u32, reorder: ^u32, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t) -> c.size_t ---
	...
	* destination must contain enough space for the resulting index buffer (index_count elements)
	*/
	optimizeVertexCache :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t) ---
	...
	* destination must contain enough space for the resulting index buffer (index_count elements)
	*/
	optimizeVertexCacheStrip :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t) ---
	...
	*/
	optimizeVertexCacheFifo :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t, cache_size: u32) ---
	...
	*/
	optimizeOverdraw :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, threshold: f32) ---
	...
	*/
	optimizeVertexFetch :: proc(destination: rawptr, indices: ^u32, #any_int index_count: c.size_t, vertices: rawptr, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t) -> c.size_t ---
	...
	* destination must contain enough space for the resulting remap table (vertex_count elements)
	*/
	optimizeVertexFetchRemap :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t) -> c.size_t ---
	...
	*/
	encodeIndexBuffer      :: proc(buffer: ^u8, #any_int buffer_size: c.size_t, indices: ^u32, #any_int index_count: c.size_t) -> c.size_t ---
	encodeIndexBufferBound :: proc(#any_int index_count: c.size_t, #any_int vertex_count: c.size_t) -> c.size_t ---
	...
	* destination must contain enough space for the resulting index buffer (index_count elements)
	*/
	decodeIndexBuffer :: proc(destination: rawptr, #any_int index_count: c.size_t, #any_int index_size: c.size_t, buffer: ^u8, #any_int buffer_size: c.size_t) -> i32 ---
	...
	*/
	decodeIndexVersion :: proc(buffer: ^u8, #any_int buffer_size: c.size_t) -> i32 ---
	...
	*/
	encodeIndexSequence      :: proc(buffer: ^u8, #any_int buffer_size: c.size_t, indices: ^u32, #any_int index_count: c.size_t) -> c.size_t ---
	encodeIndexSequenceBound :: proc(#any_int index_count: c.size_t, #any_int vertex_count: c.size_t) -> c.size_t ---
	...
	*/
	decodeIndexSequence :: proc(destination: rawptr, #any_int index_count: c.size_t, #any_int index_size: c.size_t, buffer: ^u8, #any_int buffer_size: c.size_t) -> i32 ---
	...
	*/
	encodeMeshlet      :: proc(buffer: ^u8, #any_int buffer_size: c.size_t, vertices: ^u32, #any_int vertex_count: c.size_t, triangles: ^u8, #any_int triangle_count: c.size_t) -> c.size_t ---
	encodeMeshletBound :: proc(#any_int max_vertices: c.size_t, #any_int max_triangles: c.size_t) -> c.size_t ---
	...
	*/
	decodeMeshlet    :: proc(vertices: rawptr, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t, triangles: rawptr, #any_int triangle_count: c.size_t, #any_int triangle_size: c.size_t, buffer: ^u8, #any_int buffer_size: c.size_t) -> i32 ---
	decodeMeshletRaw :: proc(vertices: ^u32, #any_int vertex_count: c.size_t, triangles: ^u32, #any_int triangle_count: c.size_t, buffer: ^u8, #any_int buffer_size: c.size_t) -> i32 ---
	...
	*/
	encodeVertexBuffer      :: proc(buffer: ^u8, #any_int buffer_size: c.size_t, vertices: rawptr, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t) -> c.size_t ---
	encodeVertexBufferBound :: proc(#any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t) -> c.size_t ---
	...
	*/
	encodeVertexBufferLevel :: proc(buffer: ^u8, #any_int buffer_size: c.size_t, vertices: rawptr, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t, level: i32, version: i32) -> c.size_t ---
	...
	* vertex_size must be a multiple of 4 (and <= 256)
	*/
	decodeVertexBuffer :: proc(destination: rawptr, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t, buffer: ^u8, #any_int buffer_size: c.size_t) -> i32 ---
	...
	* Note that a non-negative value doesn't guarantee that the buffer will be decoded correctly if the input is malformed.
	*/
	decodeVertexVersion :: proc(buffer: ^u8, #any_int buffer_size: c.size_t) -> i32 ---
	...
	*/
	decodeFilterOct   :: proc(buffer: rawptr, #any_int count: c.size_t, #any_int stride: c.size_t) ---
	decodeFilterQuat  :: proc(buffer: rawptr, #any_int count: c.size_t, #any_int stride: c.size_t) ---
	decodeFilterExp   :: proc(buffer: rawptr, #any_int count: c.size_t, #any_int stride: c.size_t) ---
	decodeFilterColor :: proc(buffer: rawptr, #any_int count: c.size_t, #any_int stride: c.size_t) ---
}
...
@(default_calling_convention="c", link_prefix="meshopt_")
foreign lib {
	encodeFilterOct   :: proc(destination: rawptr, #any_int count: c.size_t, #any_int stride: c.size_t, bits: i32, data: ^f32) ---
	encodeFilterQuat  :: proc(destination: rawptr, #any_int count: c.size_t, #any_int stride: c.size_t, bits: i32, data: ^f32) ---
	encodeFilterExp   :: proc(destination: rawptr, #any_int count: c.size_t, #any_int stride: c.size_t, bits: i32, data: ^f32, mode: Encode_Exp_Mode) ---
	encodeFilterColor :: proc(destination: rawptr, #any_int count: c.size_t, #any_int stride: c.size_t, bits: i32, data: ^f32) ---
}
...
foreign lib {
	...
	*/
	simplify :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, #any_int target_index_count: c.size_t, target_error: f32, options: Simplify_Options, result_error: ^f32) -> c.size_t ---
	...
	* result_error can be NULL; when it's not NULL, it will contain the resulting (relative/absolute) error after simplification
	*/
	simplifyWithAttributes :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, vertex_attributes: ^f32, #any_int vertex_attributes_stride: c.size_t, attribute_weights: ^f32, #any_int attribute_count: c.size_t, vertex_lock: ^u8, #any_int target_index_count: c.size_t, target_error: f32, options: Simplify_Options, result_error: ^f32) -> c.size_t ---
	...
	* result_error can be NULL; when it's not NULL, it will contain the resulting (relative/absolute) error after simplification
	*/
	simplifyWithUpdate :: proc(indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, vertex_attributes: ^f32, #any_int vertex_attributes_stride: c.size_t, attribute_weights: ^f32, #any_int attribute_count: c.size_t, vertex_lock: ^u8, #any_int target_index_count: c.size_t, target_error: f32, options: Simplify_Options, result_error: ^f32) -> c.size_t ---
	...
	*/
	simplifySloppy :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, vertex_lock: ^u8, #any_int target_index_count: c.size_t, target_error: f32, result_error: ^f32) -> c.size_t ---
	...
	* target_error represents the error relative to mesh extents that can be tolerated, e.g. 0.01 = 1% deformation; value range [0..1]
	*/
	simplifyPrune :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, target_error: f32) -> c.size_t ---
	...
	*/
	simplifyPoints :: proc(destination: ^u32, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, vertex_colors: ^f32, #any_int vertex_colors_stride: c.size_t, color_weight: f32, #any_int target_vertex_count: c.size_t) -> c.size_t ---
	...
	*/
	simplifyScale :: proc(vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) -> f32 ---
	...
	*/
	stripify      :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t, restart_index: u32) -> c.size_t ---
	stripifyBound :: proc(#any_int index_count: c.size_t) -> c.size_t ---
	...
	*/
	unstripify      :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, restart_index: u32) -> c.size_t ---
	unstripifyBound :: proc(#any_int index_count: c.size_t) -> c.size_t ---
}
...
foreign lib {
	...
	*/
	analyzeVertexCache :: proc(indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t, cache_size: u32, warp_size: u32, primgroup_size: u32) -> Vertex_Cache_Statistics ---
}
...
foreign lib {
	...
	* Results may not match actual GPU performance
	*/
	analyzeVertexFetch :: proc(indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t, #any_int vertex_size: c.size_t) -> Vertex_Fetch_Statistics ---
}
...
foreign lib {
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	analyzeOverdraw :: proc(indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) -> Overdraw_Statistics ---
}
...
foreign lib {
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	analyzeCoverage :: proc(indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) -> Coverage_Statistics ---
}
...
foreign lib {
	...
	*/
	buildMeshlets      :: proc(meshlets: ^Meshlet, meshlet_vertices: ^u32, meshlet_triangles: ^u8, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, #any_int max_vertices: c.size_t, #any_int max_triangles: c.size_t, cone_weight: f32) -> c.size_t ---
	buildMeshletsScan  :: proc(meshlets: ^Meshlet, meshlet_vertices: ^u32, meshlet_triangles: ^u8, indices: ^u32, #any_int index_count: c.size_t, #any_int vertex_count: c.size_t, #any_int max_vertices: c.size_t, #any_int max_triangles: c.size_t) -> c.size_t ---
	buildMeshletsBound :: proc(#any_int index_count: c.size_t, #any_int max_vertices: c.size_t, #any_int max_triangles: c.size_t) -> c.size_t ---
	...
	*/
	buildMeshletsFlex :: proc(meshlets: ^Meshlet, meshlet_vertices: ^u32, meshlet_triangles: ^u8, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, #any_int max_vertices: c.size_t, #any_int min_triangles: c.size_t, #any_int max_triangles: c.size_t, cone_weight: f32, split_factor: f32) -> c.size_t ---
	...
	*/
	buildMeshletsSpatial :: proc(meshlets: ^Meshlet, meshlet_vertices: ^u32, meshlet_triangles: ^u8, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, #any_int max_vertices: c.size_t, #any_int min_triangles: c.size_t, #any_int max_triangles: c.size_t, fill_weight: f32) -> c.size_t ---
	...
	*/
	optimizeMeshlet :: proc(meshlet_vertices: ^u32, meshlet_triangles: ^u8, #any_int triangle_count: c.size_t, #any_int vertex_count: c.size_t) ---
	...
	*/
	optimizeMeshletLevel :: proc(meshlet_vertices: ^u32, #any_int vertex_count: c.size_t, meshlet_triangles: ^u8, #any_int triangle_count: c.size_t, level: i32) ---
}
...
foreign lib {
	...
	*/
	computeClusterBounds :: proc(indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) -> Bounds ---
	computeMeshletBounds :: proc(meshlet_vertices: ^u32, meshlet_triangles: ^u8, #any_int triangle_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) -> Bounds ---
	...
	*/
	computeSphereBounds :: proc(positions: ^f32, #any_int count: c.size_t, #any_int positions_stride: c.size_t, radii: ^f32, #any_int radii_stride: c.size_t) -> Bounds ---
	...
	*/
	extractMeshletIndices :: proc(vertices: ^u32, triangles: ^u8, indices: ^u32, #any_int index_count: c.size_t) -> c.size_t ---
	...
	*/
	partitionClusters :: proc(destination: ^u32, cluster_indices: ^u32, #any_int total_index_count: c.size_t, cluster_index_counts: ^u32, #any_int cluster_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, #any_int target_partition_size: c.size_t) -> c.size_t ---
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	spatialSortRemap :: proc(destination: ^u32, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) ---
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	spatialSortTriangles :: proc(destination: ^u32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t) ---
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	spatialClusterPoints :: proc(destination: ^u32, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, #any_int cluster_size: c.size_t) ---
	...
	*/
	opacityMapMeasure :: proc(levels: ^u8, sources: ^u32, omm_indices: ^i32, indices: ^u32, #any_int index_count: c.size_t, vertex_uvs: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_uvs_stride: c.size_t, texture_width: u32, texture_height: u32, max_level: i32, target_edge: f32) -> c.size_t ---
	...
	*/
	opacityMapRasterize :: proc(result: ^u8, level: i32, states: i32, uv0: ^f32, uv1: ^f32, uv2: ^f32, texture_data: ^u8, #any_int texture_stride: c.size_t, #any_int texture_pitch: c.size_t, texture_width: u32, texture_height: u32) ---
	...
	* states should be 2 for 2-state format (opaque/transparent) and 4 for 4-state format (opaque/transparent/unknown)
	*/
	opacityMapCompact :: proc(data: ^u8, #any_int data_size: c.size_t, levels: ^u8, offsets: ^u32, #any_int omm_count: c.size_t, omm_indices: ^i32, #any_int triangle_count: c.size_t, states: i32) -> c.size_t ---
}

Tangent_Options_Flags :: enum u32 {
...
*/
Tangent_Options :: bit_set[Tangent_Options_Flags; u32]
...
foreign lib {
	...
	* vertex_uvs should have float2 texture coordinate in the first 8 bytes of each vertex
	*/
	generateTangents :: proc(result: ^f32, indices: ^u32, #any_int index_count: c.size_t, vertex_positions: ^f32, #any_int vertex_count: c.size_t, #any_int vertex_positions_stride: c.size_t, vertex_normals: ^f32, #any_int vertex_normals_stride: c.size_t, vertex_uvs: ^f32, #any_int vertex_uvs_stride: c.size_t, options: Tangent_Options) ---
