...
foreign lib {
	...
	encodeFilterExp   :: proc(destination: rawptr, count: c.size_t, stride: c.size_t, bits: i32, data: ^f32, mode: Encode_Exp_Mode) ---
...
foreign lib {
	...
	*/
	analyzeVertexCache :: proc(indices: ^u32, index_count: c.size_t, vertex_count: c.size_t, cache_size: u32, warp_size: u32, primgroup_size: u32) -> Vertex_Cache_Statistics ---
}
...
foreign lib {
	...
	* Results may not match actual GPU performance
	*/
	analyzeVertexFetch :: proc(indices: ^u32, index_count: c.size_t, vertex_count: c.size_t, vertex_size: c.size_t) -> Vertex_Fetch_Statistics ---
}
...
foreign lib {
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	analyzeOverdraw :: proc(indices: ^u32, index_count: c.size_t, vertex_positions: ^f32, vertex_count: c.size_t, vertex_positions_stride: c.size_t) -> Overdraw_Statistics ---
}
...
foreign lib {
	...
	* vertex_positions should have float3 position in the first 12 bytes of each vertex
	*/
	analyzeCoverage :: proc(indices: ^u32, index_count: c.size_t, vertex_positions: ^f32, vertex_count: c.size_t, vertex_positions_stride: c.size_t) -> Coverage_Statistics ---
}
